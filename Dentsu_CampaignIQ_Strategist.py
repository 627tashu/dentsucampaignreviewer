...
st.set_page_config(
    page_title="Dentsu Campaign IQ Strategist",
    page_icon="🔵",
    layout="wide",
...
def render_login():
    ...
    * Input fields */
    ...
    /* Placeholder styling */
        input::placeholder {
        color: rgba(255, 255, 255, 0.65) !important;  /* soft light white */
...
unsafe_allow_html=True)
    ...
    with c2:
        ...
        <div class="login-brand">
            ...
            <h1>Dentsu <span>Campaign IQ Strategist</span></h1>
            <div class="lb-tag">Intelligent Campaign Reviewer</div>
            <div class="lb-desc">
                Your AI-powered research & strategy companion — analyze briefs and documents, explore data,
                search the web, validate readiness, ensure compliance, and deliver insights for smarter decisions in seconds.
            </div>
            <div class="login-features">
                <div class="login-feat"><span class="lf-dot"></span> Document Q&A</div>
                <div class="login-feat"><span class="lf-dot"></span> Guideline Validation</div>
                <div class="login-feat"><span class="lf-dot"></span> Strategy Recommender</div>
...
def render_sidebar():
    ...
    with st.sidebar:
        st.markdown('<div class="brand-box"><div class="logo">🤖 Dentsu CampaignIQ Strategist</div><div class="sub">AI Campaign Reviwer</div></div>', unsafe_allow_html=True)
